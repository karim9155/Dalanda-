...
@Component
public class FiscalStamp1000Strategy implements TaxStrategy {
    private static final BigDecimal RATE = BigDecimal.valueOf(0.01); // 1.000%
    ...
    public TaxOption getTaxOption() {
        return TaxOption.FISCAL_STAMP_1000;
    }
}
